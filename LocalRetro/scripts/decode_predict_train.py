...
def main(args):   
    ...
    prediction_file =  '../outputs/raw_prediction_train/' + result_name
    raw_predictions = {}
    ...
    output_path = '../outputs/decoded_prediction_train/' + result_name
...
if __name__ == '__main__':      
    ...
    mkdir_p('../outputs/decoded_prediction_train')
    main(args) 
